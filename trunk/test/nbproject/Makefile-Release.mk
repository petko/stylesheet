...
${OBJECTDIR}/src/TestElement.o: nbproject/Makefile-${CND_CONF}.mk src/TestElement.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TestElement.o src/TestElement.cpp

${OBJECTDIR}/src/TestSelector.o: nbproject/Makefile-${CND_CONF}.mk src/TestSelector.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TestSelector.o src/TestSelector.cpp

${OBJECTDIR}/src/TestStyleSheet.o: nbproject/Makefile-${CND_CONF}.mk src/TestStyleSheet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TestStyleSheet.o src/TestStyleSheet.cpp

${OBJECTDIR}/src/TestParser.o: nbproject/Makefile-${CND_CONF}.mk src/TestParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TestParser.o src/TestParser.cpp

${OBJECTDIR}/src/TestProperty.o: nbproject/Makefile-${CND_CONF}.mk src/TestProperty.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/TestProperty.o src/TestProperty.cpp
